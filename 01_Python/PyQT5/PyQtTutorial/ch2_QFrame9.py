import sys
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QHBoxLayout, QFormLayout, QLineEdit, QPushButton, QComboBox, QTableWidget, QTableWidgetItem, QFrame, QSplitter, QLabel
...
class MainWindow(QWidget):
    ...
    def create_crud_frame_bank(self):
        ...
        self.search_bar.setPlaceholderText("Search by Account Number")
        self.search_bar.textChanged.connect(self.filter_table_bank)
        ...
        self.sample_bank_data = [
            ("SBI", "123456", "SBIN0000123", "1234", "123"),
            ("ICICI", "654321", "ICIC0000987", "5678", "456"),
            ("HDFC", "112233", "HDFC0000987", "9101", "789")
        ]

        self.populate_table(self.bank_table, self.sample_bank_data)

        frame.setLayout(layout)
        return frame

    def filter_table_bank(self):
        """Filter the bank table based on account number."""
        filter_text = self.search_bar.text()
        filtered_data = [data for data in self.sample_bank_data if filter_text in data[1]]  # Filtering by Account Number
        self.populate_table(self.bank_table, filtered_data)
    ...
    def populate_table(self, table, data):
        ...
        for row_data in data:
            ...
            for column, value in enumerate(row_data):
                table.setItem(row_position, column, QTableWidgetItem(str(value)))
