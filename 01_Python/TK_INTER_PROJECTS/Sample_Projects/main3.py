...
class App:
    ...
    def show_admin_frame(self):
        self.hide_all_frames()
        self.admin_menu_frame.pack(side="left", fill="y")
    ...
    def create_sales_frame(self):
        ...
        header.pack(fill="x")
        tk.Label(header, text="Sales Section", font=("Arial", 24), bg="#4682B4", fg="white").pack(pady=10)
        return frame
    ...
    def create_stock_frame(self):
        ...
        header.pack(fill="x")
        tk.Label(header, text="Stock Section", font=("Arial", 24), bg="#3CB371", fg="white").pack(pady=10)
        return frame
    ...
    def create_report_frame(self):
        ...
        header.pack(fill="x")
        tk.Label(header, text="Report Section", font=("Arial", 24), bg="#FFA500", fg="white").pack(pady=10)
        return frame
    ...
    def create_admin_frames(self):
        ...
        for text, command in admin_options:
            tk.Button(menu_frame, text=text, font=("Arial", 12), width=20, command=command).pack(pady=5, padx=10)
    ...
    def show_admin_option(self, option):
        ...
        header_frame = tk.Frame(self.admin_content_frame, bg="#CD5C5C")  # Light Red header for Admin
        header_frame.pack(fill="x")
        tk.Label(header_frame, text=option, font=("Arial", 18), bg="#CD5C5C", fg="white").pack(pady=10)

        content_frame = tk.Frame(self.admin_content_frame, bg="#FFE4E1")  # Misty rose background for content
        content_frame.pack(fill="both", expand=True)

        # Placeholder content for now
        tk.Label(content_frame, text=f"Content for {option}", font=("Arial", 14), bg="#FFE4E1").pack(pady=10)
