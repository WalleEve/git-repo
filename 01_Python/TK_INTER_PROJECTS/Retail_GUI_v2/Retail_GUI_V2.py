...
def purchase_window():
    ...
    Button(header_frame, text="Back", font=("Calibri", 12), bg="crimson", command=pur_back).pack(side=RIGHT)
...
def login_dashboard():
    ...
    # Labels
    back_btn = Button(login_Dashboard_Frame, text="Logout", font=("Calibri", 12, 'bold'), bg="crimson", command=logout ).pack( anchor=NE)
    ...
    Button(purchase_btn_frame, text="Purchase",  bd=4, font=("Calibri", 12, 'bold'),  bg="#43CD80", command=purchase_window).pack( fill=BOTH)
...
# MAIN FRAIM:
main_frame = Frame(master,  bd=4, relief=RIDGE,  bg="#003e53")
main_frame.place(x=1, y=1, width=498, height=498)

# Labels:
Label(main_frame, text = "General Retail Store.", font = ("Calibri", 14, "bold"), bg="#003e53", fg="white").pack(fill=BOTH)
Label(main_frame, text = "World Famous Store Keeper", font = ("Calibri", 12), bg="#003e53", fg="white").pack(fill=BOTH)
Label(main_frame, image=img).pack()

clock_label = Label(main_frame, bg="green", fg="white", font = ("Times", 12, 'bold'), relief='flat')
clock_label.place(x = 400, y = 10)
...
# LOGIN ENTRY FRAME:
log_entry_frame = Frame(main_frame,  bd=0, relief=RIDGE,  bg="#003e53")
log_entry_frame.place(x=1, y=370, width=486, height=115)

# LABEL
uname = Label(log_entry_frame, text="User Name: ", fg="white", bg="#003e53", font=("Calibri", 12))
uname.grid(row=0, column=0, sticky=W, pady=2)
pwd = Label(log_entry_frame, text="Password: ", fg="white", bg="#003e53", font=("Calibri", 12))
pwd.grid(row=1, column=0, sticky=W, pady=2)
login_notif = Label(log_entry_frame,  bg="#003e53", font=("Calibri", 12))
login_notif.grid(row=2, column=1, columnspan=2, sticky=W)
...
t_uname = Entry(log_entry_frame, textvariable = temp_login_name, width=30)
t_uname.grid(row=0, column=1, sticky=W, pady=2)
t_pwd = Entry(log_entry_frame, textvariable = temp_login_password, width=30, show="*")
t_pwd.grid(row=1, column=1, sticky=W, pady=2)
# Button:
log = Button(log_entry_frame, text="Login", width=15, command=login)
log.grid(row=2, column=0, sticky=W, padx=2, pady=10)
